...
//                .cors(cors -> cors.disable())
                .authorizeRequests()
                .requestMatchers("/blog/allPosts","/api/payment/create-intent","/ws/**","groups/supportGroups", "/extra/addDetails", "user/post/**", "/user/getPosts", "/user/post", "/user/eat/**", "/generate-token", "/user/register", "/therapists/").permitAll()
